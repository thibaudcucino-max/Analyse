...
function filterBarHtml(){
  ...
  return `<div class="qual-filterbar simple-filters">
    ...
    <div class="qf qf-range"><label>Année de construction</label><div class="filter-range"><input id="qfConstructionMin" type="number" min="1700" max="2100" step="1" value="${esc(f.constructionMin||'')}" placeholder="Min" oninput="refreshQualifiedView()"><span>à</span><input id="qfConstructionMax" type="number" min="1700" max="2100" step="1" value="${esc(f.constructionMax||'')}" placeholder="Max" oninput="refreshQualifiedView()"></div></div>
